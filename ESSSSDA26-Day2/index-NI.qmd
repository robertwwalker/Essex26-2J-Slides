...
Lets have a look at a [little simulation](https://ESSSSDA25-2W.netlify.app/posts/spurious-regressions/)
...
## Intuition for ACF/PACG

:::: {.columns}

::: {.column width="50%"}
[One way of getting a handle on this is to attempt to measure it.  [From the inimitable Allison Horst....](https://twitter.com/allison_horst/status/1361545021980217345?lang=en)
:::
::: {.column width="50%"}
